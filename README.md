...
Auto-updated by [DotaFlow](https://dotaflow.com) parsers, published
to [github.com/DotaFlow/steam_api_dumps](https://github.com/DotaFlow/steam_api_dumps).
...
- Bodies are mostly **raw API JSON** as returned by Steam / datafeed; `_VersionsHistory.json` and a few helpers are
  parser-maintained.
