...
- **GetSDRConfig.json**: latest response from ISteamApps/GetSDRConfig steam API
...
____
- #### steamEvents
- - **_News%app_id%_%lang%.json**: all news for app_id (cs2, dota2, deadlock checked) on two languages (ru, en)
____
